...
<head>
    ...
    <meta name="description" content="منصة استثمار جماعية تهدف الي المساهمة الجماعية في إنشاء او تطوير مشاريع عقارية غير مستغلة  ">
    <meta name="robots" content="noindex, follow" />

    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="assets/img/logo/logo.svg">
...
<div class="min-h-screen bg-gray-100">
    ...
    <!-- Page Content -->
    <main class="wrapper wrapper-boxed-layout">
        <livewire:header/>
